...
//  t1.begin(tickSteppers, 100   );  // call every 100µs, change if requred OK. If it's shorter it's preciser
 ...
 PC0=tourTest*10; // premier devant moi
...
//============
 void readDataFromProcessingToSerial1() {  // commenté car sinon il ralentit les moteurs// READ 30 datas even if there is ony 24 datas from Processing
